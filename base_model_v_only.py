...
class BaseModel(nn.Module):
    def __init__(self, w_emb, q_emb, v_att, q_net, v_net, classifier, mask_classifier):
    ...
    def forward(self, v, q, labels, bias, v_mask, q_mask=None, loss_type=None):
        """Forward
...
def build_baseline0_newatt(dataset, num_hid):
    ...
    return BaseModel(w_emb, q_emb, v_att, q_net, v_net, classifier, mask_classifier)